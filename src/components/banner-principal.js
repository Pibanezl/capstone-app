...
function BannerPrincipal() {
    ...
    return (
        ...
        <div>
            <img className="slider-img" src="https://www.webpurify.com/site/wp-content/uploads/2020/08/comnunity-guidelines.jpg" alt="nobullyng" />
            <div className="slider-text">
        ...
        <div>
            <img className="slider-img" src="https://www.utahsafetycouncil.org/uploads/Sq.Logo_Web(1).jpg" alt="otros" />
            <div className="slider-text">
